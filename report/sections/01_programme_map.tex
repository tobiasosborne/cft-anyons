...
\begin{aligned}
  ...
  \;\longrightarrow\;
  \underbrace{\text{lattice symmetry generators}}_{\text{e.g.\ Koo--Saleur } L_n}\\[4pt]
...
\begin{itemize}
  \item What is the target object: a conformal net, a vertex operator algebra,
  a Wightman theory, or an Osterwalder--Schrader theory?
