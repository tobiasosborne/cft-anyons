...
or antisymmetric (fermionic) Fock space; see ``Symmetries come later'' below.
...
\subsection{Symmetries Come Later (the Deferred Quotient)}

The full Fock space is the carrier on which exchange symmetry acts; it is not
itself a (anti)symmetric space. For each $n$ the permutation group $S_n$ acts
unitarily on $H^{\hotimes n}$ by permuting tensor slots. Bosonic and fermionic Fock
spaces are then the images of the per-sector orthogonal projectors
\[
