...
% Source: references/text/CFTFromLatticeFermions.txt:2182 -- lattice Fourier modes of Hamiltonian density.
% Source: references/text/CFTFromLatticeFermions.txt:2233 -- smeared KS approximants converge in the cited setting.
...
different construction.  Koo--Saleur Fourier modes are the better sourced
periodic prototype.
...
4.&\text{Fix periodic-boundary first-moment conventions.}\\
