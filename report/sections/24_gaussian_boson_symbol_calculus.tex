...
Dependencies: CA-11, CA-12, CA-23, and CONVENTIONS.md (h), (j).
...
\]
This is the algebraic output of the boost-time commutator.  To match the
continuum Poincare relation \(i[H,K_a]=P_a\) with \(P_a=k_a\), one needs
\[
