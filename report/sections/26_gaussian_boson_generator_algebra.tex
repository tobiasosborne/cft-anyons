...
Brillouin grid with flat counting measure.  Define
\[
  X_a=i\partial_{k_a},
  \qquad
  h=\omega(k),
...
chosen momentum coordinate and the differential representation of rotations, in
the rotation sign convention of CONVENTIONS.md (k).
