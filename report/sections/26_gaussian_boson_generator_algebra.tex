...
\textbf{Status: checked flat local derivation on a common core.}  The Poincare
...
on a flat \(L^2(dk)\) smooth momentum-space core, not yet a sourced OAR or
mass-shell Poincare representation theorem.
...
the one-particle commutators on the finite-particle core of this flat symbol
Fock model.  Thus the compiler can perform the first Lorentz tests at
one-particle level here, while the OAR/mass-shell Poincare bridge remains an
