...
check is a coefficient-level rejection test, not a Fock-generator check.

Dependencies: CA-24--CA-27, INDEX.md, and CONVENTIONS.md (j).

% Source: literature/md/2010.11121/2010.11121.md:274 -- lattice and dual lattice Fourier setup.
...
Fourier invariant checked in Julia for \(d=1,2,3\).
...
2.&\text{boost and rotation residual norms on shrinking low-energy windows},\\
3.&\text{comparison of open-boundary first moments with momentum-space tests}.
\end{array}
\]
The third item requires a boundary convention before it can be promoted beyond
a local experiment.
