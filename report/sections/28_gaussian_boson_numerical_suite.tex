...
assigned Fourier eigenvectors, periodic minima counts, and the implemented
coefficient residuals/Hessians.  It also checks centered periodic momentum
labels for branch-aware low-energy windows and test-local central
...
% Checked: src/GaussianBosons.jl:9--68 and :146--195; src/GaussianBosonNumerics.jl:51--214.
% Checked: test/runtests.jl:151--220 and :223--387.
...
\texttt{validate\_scalar\_coefficients}
...
3.&\text{positivity witnesses and patch/minimum certificates}.
\end{array}
\]
