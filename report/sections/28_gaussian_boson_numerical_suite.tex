...
labels for branch-aware low-energy windows, a loud finite-grid nonnegativity
gate when requested, and test-local central
...
% Checked: src/GaussianBosons.jl:9--68 and :146--195; src/GaussianBosonNumerics.jl:51--272.
% Checked: test/runtests.jl:151--220 and :223--422.
...
positive-dispersion generator statements.
...
3.&\text{rotation and boost-boost residual helpers}.
\end{array}
\]
