...
compiler is computing the intended symbols and residuals.
...
\]
and count multiple minima on an even periodic grid.  This catches the case
where the Hessian at one minimum is correct but the compiler would need a
multi-species or sector-selection output.
